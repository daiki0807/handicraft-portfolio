    ...
    return (
        <div className="min-h-screen py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-8 sm:p-12 flex flex-col justify-center">
                            ...
                            <p className="text-[var(--text-secondary)] leading-relaxed mb-8">
                                ...
                                幼い頃から母の影響で手芸に親しみ、編み物、刺繍、ソーイングなど
                ...
                {/* Contact Section */}
                <div className="bg-gradient-warm rounded-3xl p-8 sm:p-12 text-center">
                    <h3 className="font-heading text-2xl text-[var(--text-primary)] mb-4">
                        お仕事のご依頼・お問い合わせ
                    </h3>
                    <p className="text-[var(--text-secondary)] mb-6 max-w-lg mx-auto">
                        オーダーメイド制作、ワークショップ講師、取材等のご依頼は
                        SNSのDMよりお気軽にご連絡ください。
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--background-card)] text-[var(--text-primary)] font-heading rounded-full shadow-soft hover:shadow-soft-lg transition-all"
                        >
